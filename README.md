...
• Developed an interactive graphical application in C that runs on the GBA emulator where the player button input allows for in-game character 2D movement and objects collision to gain or lose points.
